...
<div class="over">
    ...
    <div class="header">
        <div class="logo">
            <a href="{{route('home')}}" title="">АвтоСпецТехника</a>
            <div class="slogan">
        ...
        <div data-offset="0" class="poster">
            ...
            <div class="kovsh_cont">
                <div data-offset="50" class="layer-4 landscape1">
                    <div class="kovsh_shadow"><img src="{{route('home')}}/css/images/kovsh_shadow.png" alt=""/></div>
                </div>
            </div>
            <div data-offset="0" class="layer-3 ramka"></div>
            <div data-offset="50" class="layer-4 landscape1">
                <div class="kovsh"><img src="{{route('home')}}/css/images/kovsh.png" alt=""/></div>
            </div>
    ...
    <div class="left">
        ...
        <div class="skroll_bl">
            <section id="title_portf" data-speed="0" data-type="background" style="background: url({{route('home')}}/css/images/skroll_bl.jpg) 0 0 no-repeat fixed;">
        ...
        <div class="vnutr_text">
            ...
            <div class="icons">
                <div class="icons_res">
                    <div class="icons_bl">
                        <div class="icons_img">
                            <img src="{{route('home')}}/images/ic_1.svg" alt=""/>
                        </div>
                ...
                <div class="icons_res">
                    <div class="icons_bl">
                        <div class="icons_img">
                            <img src="{{route('home')}}/images/ic_3.svg" alt=""/>
                        </div>
                        <div class="icons_text">
                ...
                <div class="icons_res">
                    <div class="icons_bl">
                        <div class="icons_img">
                            <img src="{{route('home')}}/images/ic_2.svg" alt=""/>
                        </div>
                        <div class="icons_text">
                            Заключение договора
                        </div>
                ...
                <div class="icons_res">
                    <div class="icons_bl">
                        <div class="icons_img">
                            <img src="{{route('home')}}/images/ic_4.svg" alt=""/>
                        </div>
                        <div class="icons_text">
